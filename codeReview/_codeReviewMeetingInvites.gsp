   ...
   <table style="width:70%;border:1px solid #ddd">
        <tbody>
            <tr>
			 ...
			 <tr>
                <td style="color: #333; font-size:13px; padding: 21px 10px 12px 10px;">   Hi Team,</td>
            </tr>
            <tr>
				  <td style="padding: 25px 9px 11px 30px;"> 
				    This email is to serve as a reminder for the code review for ${project_name} which is scheduled for ${scheduleDate} at ${startTime}.
				</td>
			</tr>
           <tr>
