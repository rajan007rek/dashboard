        ...
        <tbody>
            ...
            <tr>
				<td style="padding: 25px 9px 11px 30px; display:block;line-height: 18px;"> 
				  Team PMO has observed that code review meeting has not been scheduled  for <strong>"${projectName}"</strong> between <strong>${newFromDate}</strong> to <strong>${newToDate}</strong>. Following comment has been made for the same.
				</td>
			</tr>
			 <tr>
				<td style="padding: 25px 9px 11px 30px; display:block;line-height: 18px;"> 
