...
<head>
    ...
    <title>Oodles Technologies | Mobile Applications</title>
    <meta http-equiv="Content-Type" content="text/html" charset="utf-8" />
    <meta name="robots" content="index/follow" />
    <meta name="googlebot" content="noodp" />
    <meta http-equiv=" content-language" content="EN">
    <meta name="description" content="Oodles Technologies has well-built Web and Mobile development portfolio with projects of iphone and Android App Development,Bigdata projects,SaaS and Video streaming.">
    <meta name="description" content="Oodles Technologies specializes in Mobile Development projects, building native, hybrid and cross-compiled apps for android and iOS.">
    <!--[if lt IE 8]>
    ...
    <div id="work">
        <div class="title-bg">
            <div class="container">
                <div class="row">
                    <div class="span12">
                        <h1>Portfolio - Mobile Applications</h1>
                    </div>
                </div>
            </div>
        </div>
