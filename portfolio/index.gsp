...
<head>
    ...
    <title>Oodles Technologies | Portfolio</title>
    <meta http-equiv="Content-Type" content="text/html" charset="utf-8" />
    <meta name="robots" content="index/follow" />
    <meta name="googlebot" content="noodp" />
    <meta http-equiv=" content-language" content="EN">
    <meta name="description" content="Oodles Technologies is a leading web and mobile development company working on mega projects based on SaaS, BigData, Android, iOS and Blockchain.">
                    ...
                    <div id="options">
                        <ul id="filters" class="option-set clearfix" >
                            <g:each in="${categoryList}" var="category">
                            	 <li><a href="${url+'/portfolio'+category.uri}">${category?.name}</a>
								 </li>
							</g:each>
						</ul>
                    </div>
