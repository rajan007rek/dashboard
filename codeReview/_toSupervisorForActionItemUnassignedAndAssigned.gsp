        ...
        <tbody>
            ...
            <tr>
				  <td style="padding: 25px 9px 11px 30px;"> 
				   ${currentUser.firstName} ${currentUser.lastName} has Replaced responsible person for
                 action item ${actionItem.actionItemId} in ${meeting.schedule.project?.name} for meeting commenced on
