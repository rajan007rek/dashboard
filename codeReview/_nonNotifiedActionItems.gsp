        ...
        <tbody>
            ...
            <tr>
				<td style="padding: 25px 9px 11px 30px; display:block;line-height: 18px;"> 
				   Following Action Items has been assigned.
				</td>
			</tr>
            <%--<tr>
				<td style="padding: 25px 9px 11px 30px; display:block;line-height: 18px;"> 
            ...
            --%><tr>
				<td style="padding: 25px 12px 11px 12px; display:block;"> 
				    <table style="margin:0 auto;border-collapse: collapse;background-color: #f9f9f9;">
				    		<thead>
				    		<tr>
                       			<th style="width:15%;text-align:left;border:1px solid #ccc;padding:6px;"><b>Project Name</b></th>
                       			<th style="width:15%;text-align:left;border:1px solid #ccc;padding:6px;"><b>Action Item ID</b></th>
                       			<th style="width:10%;text-align:left;border:1px solid #ccc;padding:6px;"><b>Date Created</b></th>
                       			...
                       			<th style="width:10%;text-align:left;border:1px solid #ccc;padding:6px;"><b>Due Date</b></th>
                   			</tr> 
                   			</thead>
                   		<g:each var="ai" in="${groupedActionItemsPerUserList}">  
                   		<tbody>     
  						 	<tr>
							 	...
							 	<td style="text-align:left;border:1px solid #ccc;padding:6px;"><g:formatDate format="dd-MM-yyyy" date="${ai.dateCreated}" /></td>
